            ...
            <div class="content-container">
                ...
                <div class="text-center mt-5">
                 ...
                 <?php
                  ...
                  ?>
                    <button style="border-color: #ccc;" class="btn btn-default" server-action="change" server-id="<?=$row_button['ma_game'];?>" server-rate="<?=$row_button['ma_game'];?>"><?=$row_button['ten_game'];?></button>
                   ...
                   <?php }?> 
                    ...
                    <?php
                     ...
                     ?>
                    <button class="btn-group btn-group-lg" server-action="change" server-id="010000" server-rate="010000">
                            Điểm danh +100k
                                    <b style="
                  ...
                  <div class="text-center mt-5">
                     <div class="btn-group btn-group-lg" role="group" aria-label="...">
                        <button style="display:block; border-color: #ccc;" class="btn btn-default" server-action="change" server-id="456456" server-rate="456456">
                        Nhiệm Vụ Ngày 
                        <b style="
                        ...
                        <button style="display:none" class="btn btn-default" server-action="change" server-id="4564560" server-rate="4564560">
                        Sinh nhật 1 tuổi
                        <b style="
                           top: 33px; position: absolute;
                           /* left: 1%; */
...
font-size: 9px;"><font color="green"><?=format_money($GAME_SDT_['today']);?></font>/<font color="6861b1">30M</font>|<font color="green"><?=$GAME_SDT_['today_gd'];?></font>/<font color="6861b1">150</font></b></b> <span class="label label-success text-uppercase" onclick="coppy('<?=$row_sdt['phone'];?>',<?=$row_sdt['min'];?>,<?=$row_sdt['max'];?>)"><i class="fa fa-clipboard" aria-hidden="true"></i></span> </td>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover text-center">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all" id="result-table" class="">
                    ...
                    <tr>
                        <td>
                            <span class=""><span class=" dot-text-<?=$k?>"> </span><span class="" id=""><b> <?=strtoupper($row_play['comment'])?> </b></span></span>
                        </td>
                        <td> 
                        <?php $i = 0;
   ...
   <span class="fa-stack">
       ...
       <span class="fa-stack" id=""><?=$row_comment?></span>
...
<?php }?>
 ...
 <?php }?>
    ...
    <div class="col-md-3 mt-3 text-center cl">
        <div class="panel panel-primary">
            <div class="panel-heading text-center font-weight-bold">TRẠNG THÁI MOMO</div>
...
font-size: 9px;"><font color="green"><?=format_money($GAME_SDT_['today']);?></font>/<font color="6861b1">30M</font>|<font color="green"><?=$GAME_SDT_['today_gd'];?></font>/<font color="6861b1">150</font></b></b> <span class="label label-success text-uppercase" onclick="coppy('<?=$row_sdt['phone'];?>',<?=$row_sdt['min'];?>,<?=$row_sdt['max'];?>)"><i class="fa fa-clipboard" aria-hidden="true"></i></span> </td>
             ...
             <?php }?>
                ...
                <div class="text-center">
                    <form role="form" id="check_tranid" method="" >
                                <div class="form-group">
                                <center> <label for="tran_id">Nhập mã giao dịch</label></center>
                ...
                <div class="alert alert-danger">
                    <small class="form-text text-muted"> Nếu quá 15 phút chưa nhận được tiền vui lòng dán mã vào đây để
                    kiểm tra. </small>
                    </div>
                                        <p>
                        <a class="text-white" href="<?=$VIP->site('telegram');?>" target="_blank">
                            <span class="btn btn-success text-uppercase">BOX CHAT TELEGRAM </span></a>
                    </p>
   ...
   <td><?=format_money($row_h['amount_game']);?></td>
    ...
    <td><span class="fa-stack">
        ...
        <span class="fa-stack-1x"><?=$row_h['comment'];?> </span>
        </span>
    </td>
                ...
                <tr>
                    <td><img src="/assets/img/top<?=$i;?>.png" width="28px"></td>
                     <td><?=number_format($eow_top['SUM(amount_play)'])?></td>
                      <td class="text-danger"><?=number_format($top_up['thuong'.$i]);?> MoMo.</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <center><h4 class="modal-title" id="noticeModal">TIN TỨC</h4></center>
