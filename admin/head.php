...
<!-- ĐƠN VỊ THIẾT KẾ WEBSITE NGUYỄN ĐỨC DUY | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
  <link rel="stylesheet" href="/admin/plugins/fontawesome-free/css/all.min.css?<?=rand(1,999999999);?>">
<!-- ĐƠN VỊ THIẾT KẾ WEBSITE NGUYỄN ĐỨC DUY | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
  <link rel="stylesheet" href="/admin/plugins/overlayScrollbars/css/OverlayScrollbars.min.css?<?=rand(1,999999999);?>">
<!-- ĐƠN VỊ THIẾT KẾ WEBSITE NGUYỄN ĐỨC DUY | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
  <link rel="stylesheet" href="/admin/dist/css/adminlte.min.css?<?=rand(1,999999999);?>">
