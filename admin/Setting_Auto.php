...
<option value="OFF">OFF</option>
                                       ...
                                       <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="user_auto_dvfb" value="<?=$NTD->site('user_auto_dvfb');?>" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Password Auto</label>
                                                <input type="password" class="form-control" name="pass_auto_dvfb" value="<?=$NTD->site('pass_auto_dvfb');?>" require>
                                            </div>
                                        </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Token SubGiaRE </label>
