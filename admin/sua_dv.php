            ...
            <input type="hidden" name="action" value="set_sua_gia_dv">
              <input type="hidden" name="idsv" value="<?=$_GET['id'];?>">
                                    <div class="row">
                                      ...
                                      <?php 
             if($url_site_name==$URL_ADMIN){ ?>       <div class="col-md-12">
                                            <div class="form-group">
                                        <label class="form-label" for="">Thông Số: </label>
                                        ...
                                        <input type="text" class="form-control"   value="<?=$getsvdv['server_service'];?>" require>
                                           ...
                                           <div class="col-md-6">
                                            <div class="form-group">
                                        <label class="form-label" for="">Server Name (F12) : </label>
                                        <input type="text" class="form-control"   name="server_text" value="<?=$getsvdv['server_text'];?>" require>
                                     </div>
                                        </div>
