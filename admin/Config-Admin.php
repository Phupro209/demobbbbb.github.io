            ...
            <input type="hidden" name="action" value="set_config_admin">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                           ...
                                           <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label" for="">ID CloudFlare</label>
                                                <input type="text" class="form-control" name="id_cloud_flare" value="<?=$NTD->check('id_cloud_flare');?>" require>
                                            </div>
                                        </div>
                                           <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label" for="">X-Auth-Key</label>
                                                <input type="text" class="form-control" name="key_cloud_flare" value="<?=$NTD->check('key_cloud_flare');?>" require>
                                            </div>
                                        </div>
                                           <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label" for="">X-Auth-Email</label>
                                                <input type="text" class="form-control" name="email_cloud_flare" value="<?=$NTD->check('email_cloud_flare');?>" require>
                                            </div>
                                        </div>
                                            <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">NameServer1</label>
                                                <input type="text" class="form-control" name="name_sv1" value="<?=$NTD->check('name_sv1');?>" require>
                                            </div>
                                        </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">NameServer2</label>
                                                <input type="text" class="form-control" name="name_sv2" value="<?=$NTD->check('name_sv2');?>" require>
                                            </div>
                                        </div>
