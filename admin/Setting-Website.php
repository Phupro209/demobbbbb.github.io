                      ...
                      <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                             ...
                             <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Hiệu ứng tuyết</label>
                                <div class="col-sm-9">
                                    <select class="form-control show-tick" name="tuyet_roi" required>
                                        <option value="<?=$NTD->site('tuyet_roi');?>"><?=$NTD->site('tuyet_roi');?>
                                        </option>
                                        <option value="ON">ON</option>
                                        <option value="OFF">OFF</option>
                                    </select>
