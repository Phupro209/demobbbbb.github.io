...
<a href="/dich-vu/facebook/view-story" class="btn btn-primary"><img src="/assets/images/order.svg" alt="" width="25" height="25">
Thêm đơn</a>
</div>
<div class="col-6 d-grid gap-2">
<a href="/dich-vu/facebook/view-story/list" class="btn btn-outline-primary"><img src="/assets/images/list-order.svg" alt="" width="25" height="25">
Danh sách đơn</a>
</div>
</div>
</div>
...
&nbsp;(<?=$showrate['title_service']?>)&nbsp;<span class="badge bg-success text-white "><?php if($lam_tron=="ON"){echo ceil($showrate['rate_service']+($showrate['rate_service']*$chietkhau/100));}else{echo $showrate['rate_service']+($showrate['rate_service']*$chietkhau/100);}?> đ / view</span>&nbsp;<b class="text-warning">(Hoạt động)</b></label>
                </div>
            </div>
        </div> <?php }?>
