...
<div class="col-md-9">
<input <?php if($action=="follow"){?> type="text" placeholder="Nhập username cần tăng hoặc link hệ thống tự get user" onchange="igGetUsername('id');" <?php }else{?>type="url" onchange="bill();" placeholder="Nhập link video cần tăng"<?php }?> class="form-control" name="id"   >
</div>
</div>
<div class="form-group row mb-3">
...
<div class="alert bg-danger text-white" role="alert">
<h4>Vui lòng đọc tránh mất tiền</h4>
- <b>Mua bằng link bài viết công khai.</b>.
</div> </div>
</div>
