<?php require('../../config/function.php');$text=getCurURL();$dichvu1=(explode('/', $text));$dich_vu=$dichvu1['5'];if($dich_vu=="cmt"){$dtb="cmt_tiktok"; $action=$dichvu1['5']; $title="Tăng Comment";}elseif($dich_vu=="like"){$dtb="like_tiktok"; $action=$dichvu1['5']; $title="Like Video TikTok";}elseif($dich_vu=="follow"){$dtb="sub_tiktok"; $action=$dichvu1['5']; $title="Follow TikTok";}elseif($dich_vu=="view"){$dtb="view_tiktok"; $action=$dichvu1['5']; $title="View TikTok";}?><?php require('../../config/head.php');if(empty($_SESSION['username'])){header('Location: /Login'); exit;}else{$getrate=$NTD->get_list("SELECT * FROM `server_service` WHERE `code_service`='$dtb' AND `status_service`='1' AND `url_config`='".$url_site_name."' ");}?>
...
<th class="text-center text-white">Trạng thái</th>
 ...
 <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td><center><span  class="badge bg-primary text-white"><b ><?=$rowhbuff['server_buy']?></b></span></center>
                                                </td>
                                                <td><b class="text-danger"><?=$rowhbuff['soluong']?></b>
                                                </td>
