...
window.dataLayer = window.dataLayer || [];function gtag() {dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'G-EVLQMPJW25');</script>
  ...
  </head><!-- ĐƠN VỊ THIẾT KẾ WEBSITE NDD | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
  <body>
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          </form><!-- ĐƠN VỊ THIẾT KẾ WEBSITE NDD | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
         ...
         <div class="input-field">
          ...
          <div class="bitton-ntd2">
            <button type="submit" callback="" class="btn">Đăng Kí</button></div><br>
...
$('.rescallback').show();$('#callback').html(response.data);window.location.href = "/home"; window.location.href = "/home"; }else{$('.rescallback').hide();$('#callback').html(response.data);}}</script>
