...
<meta property="og:image" content="<?=BASE_URL('assets/img/home-banner.jpg');?>" /><!-- ĐƠN VỊ THIẾT KẾ WEBSITE NDD | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
...
</style><!-- ĐƠN VỊ THIẾT KẾ WEBSITE NDD | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
     ...
     <form submit-ajax="NTD" method="post"  action="<?=BASE_URL('api/account/login');?>"   class="login100-form validate-form">
           <o id="callback"></o>
					...
					<div class="">
						...
						<div class="">
						    	<a type="button" href="/Register" ><h5 class="login101-form-btn">Đăng Kí</h5></a>
     ...
     <form submit-ajax="NTD" method="post"  action="<?=BASE_URL('api/account/register');?>"   class="login100-form validate-form">
             <o id="callback"></o>
				...
				<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
					...
					<div class="">
						    	<a type="button" href="/Login" ><h5 class="login101-form-btn">Đăng Nhập</h5></a>
