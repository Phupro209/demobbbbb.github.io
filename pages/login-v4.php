...
<meta property="og:type" content="website" /><!-- ĐƠN VỊ THIẾT KẾ WEBSITE NDD | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
...
<div class="sign-user_card">
 ...
 <h4 class="title">Đăng nhập hệ thống</h4><p></p>
<small class="">Vui lòng điền thông tin.</small><p></p>
...
<button type="submit" class="btn btn-info-but btn-block btn-lg"><h5 class="text-button">Đăng nhập</h5></button>
<hr>
...
<h4 class="title">Đăng ký tài khoản</h4><p></p>
<small class="">Vui lòng điền thông tin.</small><p></p>
...
<button type="submit" class="btn btn-info-but btn-block btn-lg"><h5 class="text-button">Đăng kí</h5></button>
<hr>

<p class="mt-3"> Bạn Đã Có Tài Khoản? <a href="/Login" class="text-primary">Đăng Nhập.</a> </p>
</form>
<?php }elseif($url_name=="FORGOT-PASSWORD"){?>
<h4 class="title">Quên mật khẩu</h4><p></p>
<!-- ĐƠN VỊ THIẾT KẾ WEBSITE NDD | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
<small class="">Vui lòng điền thông tin.</small><p></p>
...
<button type="submit" rescallback="" class="btn btn-info-but btn-block btn-lg"><h5 class="text-button">Lấy Mã Xác Minh</h5></button><br>
<a type="button"  href="/Login" class="btn btn-primary btn-block btn-lg"><h7 class="text-button">Quay Lại Đăng Nhập</h7></a>
...
<h4 class="title">Đổi mật khẩu</h4><p></p>
<small class="">Vui lòng điền thông tin.</small><p></p>
...
<button type="submit" rescallback="" class="btn btn-info-but btn-block btn-lg"><h5 class="text-button">Đổi Mật Khẩu</h5></button><br>
<a type="button" href="/Login" class="btn btn-primary btn-block btn-lg"><h7 class="text-button">Quay Lại Đăng Nhập</h7></a>
...
<?php }?>
 ...
 <script src="<?=BASE_URL('assets/js/backend-bundle.min.js');?>" type="b9e3e84309a92aaf852234bf-text/javascript"></script>
    ...
    </script><!-- ĐƠN VỊ THIẾT KẾ WEBSITE NDD | ZALO: 0966080507 | TELE: @nddvpbq | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI-->
