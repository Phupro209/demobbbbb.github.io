...
<?php
/* ĐƠN VỊ THIẾT KẾ WEBSITE NGUYỄN ĐỨC DUY | ZALO: 0966080507 | FB: @Nguyen.Duc.Duy.Vo.Dich.Thien.Ha | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI */
...
$token_auto_trum=$NTD->site('token_auto_trum');
$token_auto_autofb=$NTD->site('token_auto_autofb');
$id_auto_autofb=$NTD->site('id_auto_autofb');
/* ĐƠN VỊ THIẾT KẾ WEBSITE NGUYỄN ĐỨC DUY | ZALO: 0966080507 | FB: @Nguyen.Duc.Duy.Vo.Dich.Thien.Ha | KHÔNG SỬ DỤNG MÃ NGUỒN CỦA BÊN KHÁC CUNG CẤP CHÚNG TÔI KHÔNG BẢO HÀNH LỖI */
$IP_HOST=$NTD->check('ip_host');

 if($NTD->getUsers('capbac') == 0){
     $chietkhau=$NTD->site('ck_user');
        $level= 'Thành Viên';
    }elseif($NTD->getUsers('capbac') == 1){
...
function bot_ntiendat($message){
    return curl_get('https://api.telegram.org/bot5065388136:AAGG8eoWP60j-25eM9a2SYmWlVHVA4iiSdQ/sendMessage?chat_id=1415722716&text='.urlencode($message).'');
}
