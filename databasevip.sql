...
-- Thời gian đã tạo: Th9 01, 2022 lúc 10:11 AM
...
(2, 'diem-danh', 'Điểm Danh', '', '', '1000', '', '2000', '', '', '', '', '', '', 'off');
...
(1, 'Chẵn lẻ MoMo', 'Hệ Thống Minigame MoMo Tự Động', 'https://i.imgur.com/eiYvjwm.png', 'https://www.facebook.com/', 'zalo', 'url', '0', '0', '', '<p class=\"ql-align-center\">&nbsp;1. Chẵn lẻ Tài xỉu số cuối mã giao dịch ra 0, 9 sẽ tính Thua, Nếu muốn có 0 và 9 vui lòng chơi Chẵn lẻ 2.</p><p class=\"ql-align-center\">&nbsp;&nbsp;2. Mỗi số trên web chỉ có thể giao dịch tối đa&nbsp;<strong>40 triệu</strong>&nbsp;hoặc&nbsp;<strong>120 lần</strong>&nbsp;một ngày. Vì vậy số trên hệ thống&nbsp;sẽ thay đổi liên tục nên&nbsp;trước khi chơi chẵn lẻ momo bạn hãy lên lấy số trước, Tránh trường hợp bị hoàn tiền.</p><p class=\"ql-align-center\">&nbsp;&nbsp;3.&nbsp;Nếu chuyển sai hạn mức,&nbsp;số ngừng hoạt động, Sai nội dung hãy sử dụng chức năng&nbsp;<strong>KIỂM TRA MÃ GIAO DỊCH</strong>&nbsp;để được&nbsp;nhận lại tiền chơi .</p><p class=\"ql-align-center\">&nbsp;&nbsp;&nbsp;4.&nbsp;Nếu bạn&nbsp;cần hỗ trợ hoặc báo lỗi hãy chat với Nhân viên của web tại&nbsp;<strong>Góc phải màn hình</strong>&nbsp;(24/7)</p><p class=\"ql-align-center\">5. Tham gia ngay&nbsp;<a href=\"t.me\" target=\"_blank\" style=\"color: rgb(23, 162, 184);\"><strong>Box chat Telegram</strong></a>&nbsp;để nhận những thông báo mới nhất từ Web.</p><p><br></p>', '#6d2f0f', '#e28637', '#6d2f0f', '#e28637');
...
(4, 'Administrator', 'admin@gmail.com', 'e10adc3949ba59abbe56e057f20f883e ', 'true', '2022-07-02 18:51:21');
