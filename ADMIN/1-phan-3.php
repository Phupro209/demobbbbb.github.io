    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header bg-transparent">
                <h3 class="mb-0">Cài đặt mini game 1 Phần 3</h3>
            </div>
            <div class="card-body">
     <?php
     $GET_GAME = $VIP->get_row(" SELECT * FROM `danh_sach_game` WHERE `ma_game` = '1-phan-3'  ");
     
     $GET_GAME_CONFIG_1 = $VIP->get_row(" SELECT * FROM `settings_game` WHERE `key` = '1-phan-3' AND  `phan_game` = 'comment_1' ");
     $GET_GAME_CONFIG_2 = $VIP->get_row(" SELECT * FROM `settings_game` WHERE `key` = '1-phan-3' AND  `phan_game` = 'comment_2' ");
     $GET_GAME_CONFIG_3 = $VIP->get_row(" SELECT * FROM `settings_game` WHERE `key` = '1-phan-3' AND  `phan_game` = 'comment_3' ");
     $GET_GAME_CONFIG_4 = $VIP->get_row("SELECT * FROM `settings_game` WHERE `key` = '1-phan-3' AND  `phan_game` = 'comment_4' ");
     ...
     ?>
                ...
                <form submit-ajax="VIP"  action="<?=BASE_URL('admin/mini-game/update');?>" method="post" api_token="<?=$VIP->getUsers('token');?>">
                <input type="hidden" name="_token" value="tVjXfr7sEdKf63XpMdYuGZ7wm90Bfptbq3YEqdvw">
                  <input type="hidden" name="action" value="setting_games">              <input name="service" type="hidden" value="1-phan-3">
              <div class="form-group">
                   ...
                   <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Nội Dung N0</label>
                                <input class="form-control" name="comment_1" type="text" value="<?=$GET_GAME_CONFIG_1['comment'];?>" placeholder="Nội Dung N0">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Tỉ Lệ N0</label>
                                <input class="form-control" name="tile_1" type="text" value="<?=$GET_GAME_CONFIG_1['tile'];?>" placeholder="Tỉ Lệ N0">
                            </div>
                        </div>
                    </div>
                      <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Nội Dung N1</label>
                                <input class="form-control" name="comment_2" type="text" value="<?=$GET_GAME_CONFIG_2['comment'];?>" placeholder="Nội Dung N1">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Tỉ Lệ N1</label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Tỉ Lệ N2</label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Nội Dung N3</label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Tỉ Lệ N3</label>
