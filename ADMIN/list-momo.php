                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            ...
                            <a href="/admin/momo/add" class="btn btn-sm btn-primary btn-round btn-icon" data-toggle="tooltip" data-original-title="Thêm Momo">
                ...
                <table class="table table-flush dataTable no-footer" id="datatable-basic" role="grid" aria-describedby="datatable-basic_info">
                  ...
                  $list_mm = $VIP->get_list(" SELECT * FROM `cron_momo` ") ;
                    ...
                    <tr class="odd">
                           ...
                           <td > <form submit-ajax="VIP"  action="<?=BASE_URL('admin/mini-game/update');?>" method="post" api_token="<?=$VIP->getUsers('token');?>">
