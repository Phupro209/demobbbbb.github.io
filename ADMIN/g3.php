    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header bg-transparent">
                <h3 class="mb-0">Cài đặt mini game Gấp 3</h3>
            </div>
            <div class="card-body">
     <?php
     $GET_GAME = $VIP->get_row(" SELECT * FROM `danh_sach_game` WHERE `ma_game` = 'g3'  ");
     
     $GET_GAME_CONFIG_1 = $VIP->get_row(" SELECT * FROM `settings_game` WHERE `key` = 'g3' AND  `phan_game` = 'comment_1' ");
     $GET_GAME_CONFIG_2 = $VIP->get_row(" SELECT * FROM `settings_game` WHERE `key` = 'g3' AND  `phan_game` = 'comment_2' ");
     $GET_GAME_CONFIG_3 = $VIP->get_row(" SELECT * FROM `settings_game` WHERE `key` = 'g3' AND  `phan_game` = 'comment_3' ");
     ...
     ?>
                ...
                <input type="hidden" name="_token" value="tVjXfr7sEdKf63XpMdYuGZ7wm90Bfptbq3YEqdvw">
                  <input type="hidden" name="action" value="setting_games">              <input name="service" type="hidden" value="g3">
              <div class="form-group">
                   ...
                   <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Nội Dung G3 (02,13,...,96)</label>
                      ...
                      <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Nội Dung G3 (69,66,99)</label>
                        ...
                        <div class="col-6">
                          ...
                          <div class="col-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Nội Dung G3 (123,234,456,678,789)</label>
